...
def retrieve_cfg(args, use_rlg_config=False):
    ...
    elif args.task == "OmniDexGrasp":
        return os.path.join(args.logdir, "omni_dex_grasp/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/omni_dex_grasp.yaml"
    elif args.task == "OmniDexGraspForce":
        return os.path.join(args.logdir, "omni_dex_grasp_force/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/omni_dex_grasp_force.yaml"
    elif args.task == "DexhandTeleop":
        return os.path.join(args.logdir, "dexhand_teleop/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/dexhand_teleop.yaml"
    else:
        warn_task_name()
...
def get_args(benchmark=False, use_rlg_config=False):
    custom_parameters = [
        ...
        {"name": "--datatype", "type": str, "default": "random",
         ...
         {"name": "--use_xarm6", "action": "store_true", "default": False,
         "help": "Use xarm6 or not"},
